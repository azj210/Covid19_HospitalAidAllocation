...
public class CovidMapper
    ...
    public void map(LongWritable key, Text value, Context context)
      throws IOException, InterruptedException {
        ...
        //don't count empty lines or lines that have extraneous data 
        if (line.length > 1 && (!line[1].equals("admin2")) && (!line[1].equals("unassigned")) && (!line[2].equals("diamond princess")) && (line[3].equals("us")) && (!line[1].equals("")) && (!line[2].equals(""))){
